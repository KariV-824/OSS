...
// ÌîåÎ†àÏù¥Ïñ¥ Ï†ïÎ≥¥ Íµ¨Ï°∞Ï≤¥ Ï†ïÏùò
typedef struct {
    char name[50];
    int attempt;
} Player;
...
<<<<<<< HEAD
    // ∞‘¿” ∑Á«¡
    while (!hasWon(board1, boardSize) && !hasWon(board2, boardSize)) {  // ∫∏µÂø° ¿¸«‘¿Ã ≥≤æ∆¿÷¿∏∏È
...
>>>>>>> origin/Jeon
    ...
    // Í≤åÏûÑ Ï¢ÖÎ£å, ÏµúÏ¢Ö Î≥¥Îìú ÏÉÅÌÉú Ï∂úÎ†• 
    printf("\n");
    printf("\n");
...
// Ï†ÑÌï®ÏùÑ Î≥¥ÎìúÏóê Î∞∞ÏπòÌïòÎäî Ìï®Ïàò
